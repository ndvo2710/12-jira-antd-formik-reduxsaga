...
import { GET_TASK_DETAIL_SAGA, UPDATE_STATUS_TASK_SAGA } from '../../../redux/constants/TaskFlowConst';
...
export default function Content(props) {
    ...
    const handleDragEnd = (result) => {
        let { projectId, taskId } = JSON.parse(result.draggableId); // after each drag
